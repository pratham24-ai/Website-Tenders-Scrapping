#Website-https://arwal.bih.nic.in/notice_category/tenders/
#title-ARWAL
import ssl
...
MONGO_DB_COLLECTION = "ARWAL_tender_data"

# ---------------- Target URLs ----------------
URL = "https://arwal.bih.nic.in/notice_category/tenders/"
...
def scrape_tenders():
    ...
    for row in rows:
        ...
        pdf_link = download_tag["href"] if download_tag else ""
